...
if spoon.WinWin then
    ...
    hs.hotkey.bind({'ctrl', 'alt'}, 'return', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("fullscreen") end)
    hs.hotkey.bind({'ctrl', 'alt'}, 'left', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("halfleft") end)
    hs.hotkey.bind({'ctrl', 'alt'}, 'right', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("halfright") end)
end
